...
* /user/create  
  e.g,. <http://localhost:8088/user/create>
...
* /user/activate  
  e.g,. <http://localhost:8088/user/activate>
...
* /user/login  
e.g,. <http://localhost:8088/user/login>  
...
* /user/password  
  e.g,. <http://localhost:8088/user/password>  
...
* /user/forget  
  e.g,. <http://localhost:8088/user/forget>  
...
* /user/reset  
e.g,. <http://localhost:8088/user/reset>
